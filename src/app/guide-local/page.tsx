        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            ...
            <p className="mx-auto mt-3 max-w-xl text-center text-sm text-neutral-600">
              Des artisans et professionnels de l&apos;Hérault qui contribuent à la qualité de nos prestations.
            </p>
            <div className="mt-10 grid gap-6 md:grid-cols-2">
              <a
                ...
                className="group flex flex-col gap-5 rounded-2xl border border-neutral-100 p-7 shadow-sm transition-all hover:-translate-y-1 hover:border-purple/20 hover:shadow-xl"
              >
                <div className="relative h-14 w-36">
                  <Image
                    src="/partenaires/logo-recacor.webp"
                    alt="Recacor — Garage pneus et entretien véhicules Le Crès"
                    fill
                ...
                <div>
                  <h3 className="text-base font-bold text-black">Recacor — Garage pneus &amp; entretien</h3>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Notre partenaire de confiance pour la gestion et l&apos;entretien de notre flotte
                    de véhicules de livraison. Spécialiste pneus et mécanique à Le Crès (34),
                    ils garantissent que nos équipes arrivent à l&apos;heure sur chaque événement.
                  </p>
                  <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-purple transition-all group-hover:gap-2">
                    recacor.fr <ArrowRight className="h-4 w-4" />
                  </span>
                </div>
              </a>

              <a
                href="https://boucheriesaintjeandevedas.fr/"
                target="_blank"
                rel="noopener noreferrer"
                className="group flex flex-col gap-5 rounded-2xl border border-neutral-100 p-7 shadow-sm transition-all hover:-translate-y-1 hover:border-purple/20 hover:shadow-xl"
              >
                <div className="relative h-14 w-36 overflow-hidden rounded-lg">
                  <Image
                    src="/partenaires/logo-boucherie-saint-jean-de-vedas.png"
                    alt="Boucherie Védasienne — Viandes halal et françaises Saint-Jean-de-Védas"
                    fill
                ...
                <div>
                  <h3 className="text-base font-bold text-black">Boucherie Védasienne — Saint-Jean-de-Védas</h3>
                  <p className="mt-2 text-sm leading-relaxed text-neutral-600">
                    Notre partenaire boucher pour l&apos;approvisionnement en viandes de qualité française
                    et halal. Leur exigence de sélection des produits contribue directement
                    à la qualité de nos cocktails et repas.
                  </p>
                  <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-purple transition-all group-hover:gap-2">
                    boucheriesaintjeandevedas.fr <ArrowRight className="h-4 w-4" />
                  </span>
                </div>
              </a>
            </div>
