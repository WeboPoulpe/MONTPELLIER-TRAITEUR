...
const prestationLinks = [
  { href: "/entreprises", label: "Evenements Entreprise", icon: Building2, description: "Seminaires, conferences, repas d'affaires" },
  { href: "/foires-salons", label: "Foires & Salons", icon: UtensilsCrossed, description: "Catering stands, grazing tables, cocktails VIP" },
  { href: "/evenements-prives", label: "Evenements Prives", icon: PartyPopper, description: "Anniversaires, baptemes, garden-parties" },
];
    ...
    >
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 lg:px-8">
        ...
        <div className="hidden items-center gap-1 lg:flex">
          ...
          >
            <button
              className={`group relative flex items-center gap-1 px-5 py-2 text-sm font-medium tracking-wide uppercase transition-colors duration-300 ${
                isPrestationPage ? "text-white" : "text-white/70 hover:text-white"
              }`}
            >
              Prestations
              ...
              <span
                className={`absolute bottom-0 left-1/2 h-[1.5px] -translate-x-1/2 bg-white transition-all duration-300 ${
                  isPrestationPage ? "w-3/4" : "w-0 group-hover:w-3/4"
                }`}
              />
            </button>
                ...
                >
                  {prestationLinks.map((link) => (
                    <Link
                      key={link.href}
                      href={link.href}
                      className={`group flex items-start gap-3 rounded-xl px-4 py-3 transition-all duration-200 hover:bg-white/10 ${
            ...
            <div className="flex flex-1 flex-col items-center justify-center gap-1 px-8">
              ...
              >
                <button
                  ...
                  className={`group relative inline-flex items-center gap-2 py-3 text-3xl font-bold tracking-wide transition-colors ${
                    isPrestationPage ? "text-white" : "text-white/60 hover:text-white"
                  }`}
